...
os.makedirs(os.getcwd() + '/DeepLearning/pix2pix/datasets/facades/train/A')
os.makedirs(os.getcwd() + '/DeepLearning/pix2pix/datasets/facades/test/A')
os.makedirs(os.getcwd() + '/DeepLearning/pix2pix/datasets/facades/train/B')
os.makedirs(os.getcwd() + '/DeepLearning/pix2pix/datasets/facades/test/B')
